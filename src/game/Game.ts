...
export class Game {
  ...
  private _getFireRingPressureProfile(round: number) {
    ...
    if (r === 2) return { humanDur: 0.65, times: [0.16, 0.45, 0.72], dur: 0.90, gather: 0.20, reform: 0.28, gc: { x: 125, y: 345 }, tperm: [300, 80, 190] };
    return { humanDur: 0.65, times: [0.10, 0.32, 0.54], dur: 0.78, gather: 0.14, reform: 0.20, gc: { x: this._elitePressureRound % 2 === 1 ? 255 : 125, y: 345 }, tperm: [190, 300, 80] };
  }
